...
*
* @brief:   ADBMS2950 command list implementation.
*
* @details:
*
*******************************************************************************
...
uint8_t WRCFGAs[2]        = { 0x00, 0x01 };
uint8_t WRCFGBs[2]        = { 0x00, 0x24 };
uint8_t RDCFGAs[2]        = { 0x00, 0x02 };
uint8_t RDCFGBs[2]        = { 0x00, 0x26 };
...
uint8_t CLRSTATs [2]      = { 0x07, 0x13 };
uint8_t CLRFLAGs[2]       = { 0x07, 0x17 };

/* Poll adc command */
uint8_t PLADCs[2]         = { 0x07, 0x18 };
...
/* GPIOs Comm commands */
uint8_t WRCOMMs[2]        = { 0x07, 0x21 };
uint8_t RDCOMMs[2]        = { 0x07, 0x22 };
/* command + dummy data for 72 clock cycles */
uint8_t STCOMMs[13]       = { 0x07, 0x23, 0xB9, 0xE4 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00};

/* Control Commands */
uint8_t RDSIDs[2]         = { 0x00, 0x2C };
uint8_t RSTCCs[2]         = { 0x00, 0x2E };
uint8_t SNAPs[2]          = { 0x00, 0x2D };
uint8_t UNSNAPs[2]        = { 0x00, 0x2F };
uint8_t SRSTs[2]          = { 0x00, 0x27 };
uint8_t sADI1[2]         = { 0x02, 0x60 };
uint8_t sADX[2]          = { 0x05, 0x30 };

//Command + pec
uint8_t RSTATD[4]        = {0x00, 0x33, 0x4D, 0x4A};  //Command +Pec
uint8_t RSTATCs[4]        = {0x00, 0x32, 0xc6, 0x78}; // Tiger CC is in Status C
...
uint8_t sRSTATAs [4]      = { 0x00, 0x30, 0x5B, 0x2E };
